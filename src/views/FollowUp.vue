<template>
  <div style="width: 100%;">
    ...
    <div class="table-column" >
      <!--随访档案数据区-->
      <div class="archives">随访档案数据区</div>
      <!--病人档案数据表单,固定表头，表格样式固定-->
      <el-table :data="tableData" :tree-props="{children: 'children', hasChildren: 'hasChildren'}"
                border default-expand-all row-key="id" height="250"
                style="width: 1112px; border-radius: 15px; border: #aaaaaa solid 1px;">
        <el-table-column label="档案号" prop="archivesNo" width="150"></el-table-column>
        ...
        <el-table-column label="已完成随访次数" prop="finishSequence" width="150"></el-table-column>
        <el-table-column label="下次随访时间" prop="nextDate" width="150"></el-table-column>
        <el-table-column label="当前状态" prop="nowStatus" width="100"></el-table-column>
        <!--操作列-->
        <el-table-column label="操作" prop="option" width="200">
          <template slot-scope="scope">
            <el-button round  size="mini" style="border: #c0e8cb solid 1px; color:#1f5548; background-color: #d2efc3"
                       @click="choose(scope.row)">随访采集
            </el-button>
            <el-button round size="mini" style="border: #90b477 solid 1px; color:#1f5548; background-color: #a2c38a"
                       @click="getFollowHistory(scope.row)">历史随访
            </el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog
      ...
      <el-form ref="collectForm" :model="collectForm" label-width="100px">
        ...
        <el-descriptions :column="1" border direction="vertical" title="主症">
        ...
        <el-descriptions :column="1" border direction="vertical" style="margin-top:-5%" title="中医证候信息表">
        ...
        <el-descriptions :column="1" border direction="vertical" style="margin-top:-5%" title="处方信息">
        ...
        <el-descriptions :column="1" border direction="vertical" title="病例资料拓展（特色模块）">
        ...
        <el-descriptions :column="1" border direction="vertical" title="自评医疗成效问卷（MYMOP）">
...
以是身体上的、社交上的、或精神上的活动；例如工作、运动、或其他娱乐等等），并把适当的数字勾上以表受影响的情况有多坏。">
        ...
        <el-descriptions :column="1" border direction="vertical" title="圣乔治呼吸调查问卷">
        ...
        <el-descriptions :column="1" :size="size" border title="呼吸困难量表评分（mMRC）">
          ...
          <el-collapse-item>
            <template slot="title">
              ...
              >
                ...
                <el-button style="margin-top:10px" @click="submitSoundRecording(item.id,item.soundRecordingUrl) ">提交
                </el-button>
            ...
            <el-form ref="item.survey" :model="item.survey" label-width="100px">
              ...
              <el-descriptions :column="1" border direction="vertical" style="margin-top:0%" title="中医证候信息表">
              ...
              <el-descriptions :column="1" border direction="vertical" style="margin-top:0%" title="处方信息">
                <el-descriptions-item label="治法">
